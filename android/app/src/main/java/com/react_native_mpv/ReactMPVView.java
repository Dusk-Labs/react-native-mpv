...
class ReactMPVView extends TextureView {

    private static final String TAG = "ReactMPVView";
    private final String tag = "ReactMPVView";
    ...
    public ReactMPVView(ThemedReactContext context) {
        super(context);
     ...
     *//* No indication about the density, assuming 1:1 *//*
                                                           ...
                                                           * aspectRatio = (double) mVideoVisibleWidth / (double)
                                                           * mVideoVisibleHeight;
                                                           * } else {
